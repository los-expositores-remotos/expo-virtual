...
class MongoProveedorDAOImpl : ProveedorDAO, GenericMongoDAO<Proveedor>(Proveedor::class.java) {
    ...
    fun getProveedorFromDocument(document: Document): Proveedor {
        val proveedor = Proveedor(document["companyName"].toString(), document["companyImage"].toString(), document["facebook"].toString(), document["instagram"].toString(), document["web"].toString())
