...
class FormularioDeCargaDeProveedorStepDefs {
    ...
    fun unNombreDeProveedor(proveedorData: Map<String, String>) {
        this.proveedor1 = Proveedor(proveedorData["companyName"]!!, proveedorData["companyBanner"]!!, proveedorData["companyImage"]!!, proveedorData["facebook"]!!, proveedorData["instagram"]!!, proveedorData["web"]!!)
    }
