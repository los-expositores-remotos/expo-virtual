...
public class VisualizacionDeProveedoresStepdefs {
    ...
    private ProductoService productoService = new ProductoServiceImpl(new MongoProductoDAOImpl(), DataBaseType.TEST);
    ...
    public void unProductoVacio() {
        ObjectId idDeProveedor = new ObjectId(this.proveedorId);
        Producto productoNuevo = new Producto(idDeProveedor, "ElProducto", "", "", 5, 5, 5);
        productoService.nuevoProducto(productoNuevo);
        this.producto = productoNuevo.getId().toString();
    }
