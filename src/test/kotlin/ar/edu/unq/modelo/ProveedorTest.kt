...
class ProveedorTest : ModelObjectWithBsonIdTest<Proveedor>(Proveedor::class.java) {
    ...
    override fun setUp(){
        super.setUp()
        this.proveedor = Proveedor("LaCompany", "www.banner.com/lacompany.png", "www.images.com/lacompany.png", "www.facebook.com/LaCompany", "www.instagram.com/LaCompany", "www.lacompany.com")
