...
class MongoProductoDAOTest : GenericMongoDAOTest<Producto>(MongoProductoDAOImpl()) {
    ...
    override fun generarItems() {
        ...
        this.items.add(Producto(this.proveedor.id, "Les Paul", "A electric guitar.", 7, 1000000, 800000))
        this.items.add(Producto(proveedor.id, "Les PaulB", "A electric guitar.", 7, 1000000, 800000))
